  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" fixed="right" width="200" align="center">
        <template v-slot="{row}">
          <el-button icon="el-icon-edit" type="text" size="small" :disabled="row.currentStatusCode>4"
...
import ExamineApplication from '@/views/wms/examine2/components/examine-application'
