  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" fixed="right" width="200" align="center">
        <template v-slot="{row}">
          <el-button icon="el-icon-edit" type="text" size="small" :disabled="row.currentStatusCode>2"
                     @click="confirm(row.applicationId)">用工确认</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!--原始分页    -->
    ...
    <!--  新增对话框  -->
    <confirm-application ref="addApplication" :title="title" :show-dialog.sync="showDialog"
...
import ConfirmApplication from '@/views/wms/confirm/components/confirm-application'
