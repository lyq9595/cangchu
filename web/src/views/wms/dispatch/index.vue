  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" fixed="right" width="200" align="center">
        <template v-slot="{row}">
          <el-button icon="el-icon-edit" type="text" size="small" :disabled="row.currentStatusCode>1"
                     @click="dispatch(row.applicationId)"
          >
            派工
          </el-button>
        </template>
    ...
    <!--  新增对话框  -->
    <add-application ref="addApplication" :title="title" :show-dialog.sync="showDialog"
...
import AddApplication from '@/views/wms/dispatch/components/dispatch-application'
