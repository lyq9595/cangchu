  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <!--结算信息        -->
        <h2 class="infoType m-t-15">结算信息</h2>
        <el-table  :data="checkoutInfo" border class="radiusWeak"
                  :header-cell-style="{background:'#FFFFFF',color:'#80878f'}"
        >
          <el-table-column label="人力数量" align="center" prop="employNum"/>
          <el-table-column label="机力数量" align="center" prop="carNum"/>
          <el-table-column label="人力费用" width="200" align="center" prop="laborCost"/>
          <el-table-column label="机力费用" width="200" align="center" prop="carCost"/>
          <el-table-column label="总费用" width="200" align="center" prop="totalCost"/>
          <el-table-column label="结算时间" width="200" align="center" prop="checkTime"/>
        </el-table>

      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button class="radiusWeak" size="small" icon="el-icon-close" @click="btnCancel">关闭</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    async edit(applicationId) {
      ...
      await confirm.getHistoryEmployAndCarListByAid(this.applicationIdStr).then((res) => {
      ...
      await checkout.queryCheckInfoByAid(this.applicationIdStr).then((res)=>{
        this.checkoutInfo=res.data.rows
        console.log("check",this.checkoutInfo)
      })
