  ...
  <div class="app-container select-work">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading"  :data="employData" >
          <el-table-column type="selection" width="50" align="center" />
          <el-table-column label="员工编号" align="center"  prop="employId"/>
          <el-table-column label="员工名称" align="center"  prop="employName"/>
          <el-table-column label="所属班组" align="center"  prop="employType"/>
          <el-table-column label="手机号码" align="center"  prop="employPhone"  width="120" />
          <el-table-column label="所属公司" align="center"  prop="companyName"  width="120" />
          <el-table-column label="日薪" align="center"  prop="employCost"  width="120" />
          <el-table-column
            label="操作"
            align="center"
            width="160"
...
export default {
  ...
  methods: {
   ...
   /*  else {
      ...
      this.loading = true
        await employ.getEByeId(id).then((res) => {
          if (res.code === 200) {
