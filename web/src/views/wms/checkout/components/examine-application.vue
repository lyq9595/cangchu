  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <!--用工信息        -->
        <h2 class="infoType m-t-15">人员信息</h2>
        <el-table height="180" :data="employData" border class="radiusWeak"
                  :header-cell-style="{background:'#FFFFFF',color:'#80878f'}"
        >
          <el-table-column label="编号" align="center" prop="employId"/>
          <el-table-column label="姓名" align="center" prop="employName"/>
          <el-table-column label="所属班组" align="center" prop="employType"/>
          <el-table-column label="联系电话" align="center" prop="employPhone"/>
          <el-table-column label="日薪" align="center" prop="employCost"/>
        </el-table>
        <h2 class="infoType m-t-15">车辆信息</h2>
        <el-table height="180" :data="carData" border class="radiusWeak"
                  :header-cell-style="{background:'#FFFFFF',color:'#80878f'}"
        >
          <el-table-column label="编号"   align="center"  prop="carId"/>
          ...
          <el-table-column label="日薪" align="center" prop="carCost"/>
        </el-table>


        <!--审核意见        -->
        <div style="margin:15px 0;">
          <h2 class="infoType">结算意见</h2>
          <el-card>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="radiusWeak" type="primary" icon="el-icon-check" size="small" @click="submitForm">结 算
        </el-button>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      await checkout.updateCheckoutStatus(this.applicationIdStr)
      this.$emit('update:showDialog', false)
      this.$parent.getList()
